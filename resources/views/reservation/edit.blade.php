            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="row gy-1" method="POST" action="{{ route('reservations.update', $reservation->id) }}">
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div>
                                <label for="consultand_id" class="form-label">{{ __('Consultor') }}</label>
                                <select class="form-select @error('consultand_id') is-invalid @enderror"
                                    id="consultand_id" name="consultand_id" required>
                                    <option value="">Seleccionar Consultor</option>
                                    @foreach ($consultants as $consultant)
                                        <option value="{{ $consultant->id }}"
                                            {{ $consultant->id == $reservation->consultand_id ? 'selected' : '' }}>
                                            {{ $consultant->nombres }} {{ $consultant->apellidos }}</option>
                                    @endforeach
                                </select>
                                @error('consultand_id')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div>
                                ...
                                <select class="form-select @error('start_time') is-invalid @enderror" id="start_time"
                                    ...
                                    <option value={{ $reservation->start_time }} selected>
                                        {{ $reservation->start_time }}</option>
                                    <option value="09:00" {{ $reservation->start_time == '09:00' ? 'selected' : '' }}>
                                        09:00</option>
                                    <option value="10:00" {{ $reservation->start_time == '10:00' ? 'selected' : '' }}>
                                        10:00</option>
                                    <option value="11:00" {{ $reservation->start_time == '11:00' ? 'selected' : '' }}>
                                        11:00</option>
                                    <option value="12:00" {{ $reservation->start_time == '12:00' ? 'selected' : '' }}>
                                        12:00</option>
                                    <option value="13:00" {{ $reservation->start_time == '13:00' ? 'selected' : '' }}>
                                        13:00</option>
                                    <option value="14:00" {{ $reservation->start_time == '14:00' ? 'selected' : '' }}>
                                        14:00</option>
                                    <option value="15:00" {{ $reservation->start_time == '15:00' ? 'selected' : '' }}>
                                        15:00</option>
                                    <option value="16:00" {{ $reservation->start_time == '16:00' ? 'selected' : '' }}>
                                        16:00</option>
                                </select>
                                @error('start_time')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div>
                                ...
                                <input type="text" class="form-control @error('end_time') is-invalid @enderror"
                                    ...
                                    value="{{ old('end_time', $reservation->end_time) }}" readonly>
                                @error('end_time')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div>
                                <label for="reservation_status"
                                    class="form-label">{{ __('Estado de la Reserva') }}</label>
                                <select class="form-select @error('reservation_status') is-invalid @enderror"
                                    ...
                                    <option value="pendiente"
                                        {{ $reservation->reservation_status == 'pendiente' ? 'selected' : '' }}>
                                        Pendiente</option>
                                    <option value="confirmada"
                                        {{ $reservation->reservation_status == 'confirmada' ? 'selected' : '' }}>
                                        Confirmada</option>
                                </select>
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div>
                                ...
                                <input type="text" class="form-control @error('total_amount') is-invalid @enderror"
                                    ...
                                    value="{{ old('total_amount', $reservation->total_amount) }}" readonly>
                                @error('total_amount')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-xxl-3 col-md-6">
                            <div>
                                ...
                                <select class="form-select @error('payment_status') is-invalid @enderror"
                                    ...
                                    <option value="">Seleccionar un estado</option>
                                    <option value="pendiente"
                                        {{ $reservation->payment_status == 'pendiente' ? 'selected' : '' }}>Pendiente
                                    </option>
                                    <option value="pagado"
                                        {{ $reservation->payment_status == 'pagado' ? 'selected' : '' }}>Pagado
                                    </option>
                                    <option value="fallido"
                                        {{ $reservation->payment_status == 'fallido' ? 'selected' : '' }}>Fallido
                                    </option>
                                </select>
